...
.column > .q-btn.self-stretch,
.column.items-stretch > .q-btn {
  width: auto;
}
.row > .q-btn {
  height: 100%;
}
.row > .q-btn.self-stretch {
  height: auto;
}
.row.items-start > .q-btn,
.row.items-end > .q-btn,
.row.items-center > .q-btn,
.row.items-baseline > .q-btn,
.row.items-stretch > .q-btn,
.row.q-toolbar > .q-btn,
.row.q-bar > .q-btn {
  height: auto;
}
...
.q-field--labeled:not(.q-field--float) .q-field__native::-webkit-input-placeholder, .q-field--labeled:not(.q-field--float) .q-select__input::-webkit-input-placeholder {
  color: transparent;
}
.q-field--labeled:not(.q-field--float) .q-field__native::-moz-placeholder, .q-field--labeled:not(.q-field--float) .q-select__input::-moz-placeholder {
  color: transparent;
}
.q-field--labeled:not(.q-field--float) .q-field__native:-ms-input-placeholder, .q-field--labeled:not(.q-field--float) .q-select__input:-ms-input-placeholder {
  color: transparent;
}
.q-field--labeled:not(.q-field--float) .q-field__native::-ms-input-placeholder, .q-field--labeled:not(.q-field--float) .q-select__input::-ms-input-placeholder {
  color: transparent;
...
[dir] body.platform-ios .q-menu {
  transform: translate(var(--q-vp-left), var(--q-vp-top));
}
...
[dir] body.platform-ios .q-tooltip {
  transform: translate(var(--q-vp-left), var(--q-vp-top));
}
.q-tree {
  position: relative;
...
@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {
  ...
  .q-btn-group > .q-btn > .q-focus-helper {
    z-index: -1;
  }
  .q-btn {
    overflow: visible;
